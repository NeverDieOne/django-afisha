...
class Place(models.Model):
    ...
    long_description = HTMLField('Длинное описание', db_index=True, blank=True)
...
class PlaceImage(models.Model):
    ...
    image = models.ImageField(upload_to='images', db_index=True, verbose_name='Фотография места')
